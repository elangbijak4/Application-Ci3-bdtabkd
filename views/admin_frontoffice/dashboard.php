...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>Pusat data BKD Prov. Sulawesi Selatan</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo site_url('Frontoffice/frontoffice_admin'); ?>">
        ...
        <div class="sidebar-brand-text mx-3"><font size="1.5pt">Admin Bank Data</font></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" style="cursor:pointer;" id="surat_berkas_balasan" >Surat dan Berkas Balas</a>-->
            <!--<a class="collapse-item" href="">Agenda Kerja</a>
            <a class="collapse-item" href="">Profil Tamu</a>
            <a class="collapse-item" href="">Pesan dari Tamu</a>-->
          </div>
        </div>
      </li>
