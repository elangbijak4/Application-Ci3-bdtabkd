...
<head>
    <title>Pusat Data <?php echo $this->config->item('nama_opd'); ?> Provinsi Sulawesi Selatan</title>
    <!-- Meta-Tags -->
...
<section class="main">
	<div class="layer">
		...
		<div class="bottom-grid">
			<div class="logo">
				<h1> <img src="<?php echo base_url('/assets/images/logo_sulsel.png');?>" class="logo_sulsel" style="float:left;margin-right:10px;" /><a href="index.php">Pusat Data <?php echo $this->config->item('nama_opd'); ?> Prov. Sulsel</a></h1>
			</div>
			<div class="links" >
		...
		<div class="content-w3ls">
			<div class="text-center icon">
				<span class="text-login" style="font-size:35px;color:#fff">Login Bank Data</span>
			</div>
			<div class="content-bottom">
				<form action="<?php echo site_url('login/login/process') ?>" method="post" accept-charset="utf-8">
					...
					<div class="wthree-field">
						<button type="submit" class="btn">Masuk Bank Data</button>
					</div>
					<ul class="list-login">
