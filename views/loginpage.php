...
<head>
    <title>Pusat Data BKD Provinsi Sulawesi Selatan</title>
    <!-- Meta-Tags -->
...
<section class="main">
	<div class="layer">
		...
		<div class="bottom-grid">
			<div class="logo">
				<h1> <img src="<?php echo base_url('/assets/images/logo_sulsel.png');?>" class="logo_sulsel" style="float:left;margin-right:10px;" /><a href="index.php">Pusat Data BKD Prov. Sulsel</a></h1>
			</div>
			<div class="links" >
		...
		<div class="content-w3ls">
			<div class="text-center icon">
				<span class="text-login" style="font-size:30px;">Login Bank Data</span>
			</div>
