...
class Viewfrommyframework {
            ...
            if(isset($Recordset[0])){
                ...
                foreach ($tampung_key as $value) {
                    if(in_array($value,$kolom_cari)){//timestamp_masuk
                        if($value=='timestamp_masuk')echo "<th >Tanggal dibalas</th>";else {
                ...
                foreach($Recordset as $keyisi=>$isi){
                    ...
                    echo "
                    <button style=\"float:left; margin-right:5px;\" class=\"d-sm-inline-block btn btn-sm btn-success shadow-sm kotak\" id=\"eyebuka$keyisi\"><i class='fas fa-check-circle fa-sm text-white-100'></i> Periksa</button>
                    ";
                    ...
                    */
                        ...
                        if(in_array($k,$kolom_cari)){
                            if($k!=='status_surat'){
                                if($k=='timestamp_masuk'){
                                    ...
                                    echo "<td align=left valign=top>".$temporer[0]."<br>Jam ".$temporer[1]."</td>";
                                    ...
                                    $(document).ready(function(){
                                        $(\"#lihat_keterangan$keyisi\").click(function(){
                                            ...
                                            loading.fadeIn(); 
                                            loading.fadeOut();
                                            tampilkan.html('<div align=\"left\" style=\"margin-left:20px;\"><h5>Keterangan:</h5><br>".$isi['keterangan']."</div>');
                                            tampilkan.fadeIn(2000);
                    ...
                    <td>
                    <button class=\"d-sm-inline-block btn btn-sm btn-danger shadow-sm kotak\"  style=\"width:100px; height:100%;\" id=\"eyeSlashTutup$keyisi\"><i class='fas fa-eye-slash fa-sm text-white-100'></i> <br>Tutup</button>
                    </td>
                    <style>
                        .flex-container {
                            display: flex;
                    ...
                    <button class=\"flex-item d-sm-inline-block btn btn-sm btn-success shadow-sm kotak\" id=\"isiSurat$keyisi\" data-toggle=\"modal\" data-target=\"#modal_baca_surat_new\"><i class='fas fa-envelope-open fa-sm text-white-100'></i> <br>Buka Surat</button>
                    <button class=\"flex-item d-sm-inline-block btn btn-sm btn-info shadow-sm kotak\" id=\"berkasSurat$keyisi\" data-toggle=\"modal\" data-target=\"#modal_baca_surat_new\"><i class='fas fa-folder-open fa-sm text-white-100'></i> <br>Berkas Pendukung</button>
                    <button class=\"flex-item d-sm-inline-block btn btn-sm btn-primary shadow-sm kotak\" id=\"detail_surat$keyisi\" ><i class='fas fa-cog fa-sm text-white-100'></i> <br>Detail</button>
                    </div>
                    <!--
					...
					$(document).ready(function(){
                        ...
                        $(\"#detail_surat2$keyisi\").click(function(){
                            ...
                            tampilkan.hide();
                            loading.fadeIn(); 
                            $.post('".site_url('/Frontoffice/tampilkan_rincian_surat_frontoffice_balasan')."',{key:\"".$tampung_key[0]."\",data:\"".$isi[$tampung_key[0]]."\" },
                            function(data,status){
                                loading.fadeOut();
                                tampilkan.html(data);
                                tampilkan.fadeIn(2000);
    ...
    //===========================================
    function penampil_tabel_no_foto_untuk_surat_masuk_frontoffice_surat_masuk_verifikasi_untuk_log_surat_frontoffice_di_akun ($kolom_cari,$nama_kolom_direktori_surat,$array_atribut,$query_yang_mau_ditampilkan,$submenu,$kolom_direktori='direktori',$direktori_avatar='/public/img/no-image.jpg'){
        $Recordset1=$this->CI->model_frommyframework->user_defined_query_model($query_yang_mau_ditampilkan,$token='andisinra');
        //var_dump($Recordset1);
        if (!$Recordset1) {
            echo "<center>TABEL YANG BERSESUAIAN KOSONG, SILAHKAN DIISI DULU</center>";
            ...
            if(isset($Recordset[0])){
                ...
                //echo "<h4>Kelola Surat Masuk</h4>";
                //print_r($_SERVER);
                echo "<div ".$array_atribut[0]." ><table ".$array_atribut[1]." style='background-color:#fff'><tr ".$array_atribut[2]." >";
                //echo "<th scope='col' ><span >Aksi</span></th>";
                if(in_array($kolom_direktori,$tampung_key)){
                    echo "<th ><span >Foto</span></th>";
                }
    ...
    //===========================================TAMBAHAN KHUSUS UNTUK CRUID VERIFIKASI PERBAIKAN TAMU PEGAWAI==============================
    function penampil_tabel_no_foto_untuk_surat_masuk_frontoffice_surat_masuk_verifikasi_untuk_log_surat_frontoffice_tamu_pegawai ($kolom_cari,$nama_kolom_direktori_surat,$array_atribut,$query_yang_mau_ditampilkan,$submenu,$kolom_direktori='direktori',$direktori_avatar='/public/img/no-image.jpg'){
        $Recordset1=$this->CI->model_frommyframework->user_defined_query_model($query_yang_mau_ditampilkan,$token='andisinra');
        //var_dump($Recordset1);
        if (!$Recordset1) {
            echo "<center>TABEL YANG BERSESUAIAN KOSONG, SILAHKAN DIISI DULU</center>";
    ...
    //===========================================END TAMBAHAN KHUSUS UNTUK CRUID VERIFIKASI PERBAIKAN TAMU PEGAWAI==========================
    
    //===========================================TAMBAHAN KHUSUS UNTUK CRUID VERIFIKASI PERBAIKAN===========================================
    function penampil_tabel_no_foto_untuk_surat_masuk_frontoffice_surat_masuk_verifikasi_untuk_log_surat_frontoffice ($kolom_cari,$nama_kolom_direktori_surat,$array_atribut,$query_yang_mau_ditampilkan,$submenu,$kolom_direktori='direktori',$direktori_avatar='/public/img/no-image.jpg'){
        //echo "OK BRO INIMI";
        $Recordset1=$this->CI->model_frommyframework->user_defined_query_model($query_yang_mau_ditampilkan,$token='andisinra');
        //var_dump($Recordset1);
        if (!$Recordset1) {
                ...
                foreach($Recordset as $keyisi=>$isi){
                    ...
                    */
                    ...
                    foreach ($tampung_key as $k) {
                        ...
                        if(in_array($k,$kolom_cari)){
                            if($k!=='status_surat'){
                                /*OLD Kekurangan cara ini menyebabkan banyak query ke server.
                                if($k=='posisi_surat_terakhir'){
                                    $kolom_rujukan['nama_kolom']='idsurat_masuk';
                                    $kolom_rujukan['nilai']=$isi['idsurat_masuk'];
                                    $query=$this->CI->model_frommyframework->pembaca_nilai_baris_tertentu('log_surat_masuk',$kolom_rujukan);
                                    foreach($query->result() as $row){
                                        if(preg_grep("#sekretariat#i",array($row->$k))){
                                            $buffer_sek=$row->$k;
                                        }else if(preg_grep("#bid#i",array($row->$k))){
                                            $buffer_bid=$row->$k;
                                        }else if(preg_grep("#upt#i",array($row->$k))){
                                            $buffer_upt=$row->$k;
                                        }
                                    }
                                    if(isset($buffer_upt)){
                                        echo "<td align=left valign=top>".$buffer_upt."</td>";
                                        unset($buffer_upt);
                                    }else if(isset($buffer_bid)){
                                        echo "<td align=left valign=top>".$buffer_bid."</td>";
                                        unset($buffer_bid);
                                    }else{
                                        if(isset($buffer_sek)){
                                            echo "<td align=left valign=top>".$buffer_sek."</td>";
                                            unset($buffer_sek);
                                        }else{
                                            echo "<td align=left valign=top>".$isi[$k]."</td>";
                                        }
                                    ...
                                    ";
                                } else if($k=='idsurat_masuk') {
                                    
                                    echo "
                                    <style>
                                    #tutup_rincian_history$keyisi{
                                        display:none;
                                    }
                                    </style>
                                    <td align=left valign=top>".$isi[$k]."<br>
                                    <button class=\"btn btn-sm btn-info shadow-sm kotak\" id=\"lihat_rincian_history$keyisi\"><i class='fas fa-eye fa-sm text-white-100'></i></button>
                                    <button class=\"btn btn-sm btn-danger shadow-sm kotak\" id=\"tutup_rincian_history$keyisi\"><i class='fas fa-eye-slash fa-sm text-white-100'></i></button>
                                    </td>";
                                } else {
                                    echo "<td align=left valign=top>".$isi[$k]."</td>";
                                }
                    ...
                    //$size=sizeof($kolom_cari);
                    echo "
                            <tr id='pra_rincian_history$keyisi' style='display:none;' align='center' >
                            <td colspan=".sizeof($kolom_cari).">
                            <i class='fa-3x fas fa-spinner fa-pulse' ".$this->CI->config->item('style_progres_bulat_admin')."></i>
                            </td>
                            </tr>
                            <tr id=\"rincian_history$keyisi\" >
                            </tr>
                            <script>
                            $(document).ready(function(){
                                $(\"#lihat_rincian_history$keyisi\").click(function(){
                                    $(\"#lihat_rincian_history$keyisi\").hide(500);
                                    $(\"#tutup_rincian_history$keyisi\").show(500);
                                    var loading = $(\"#pra_rincian_history$keyisi\");
                                    var tampilkan = $(\"#rincian_history$keyisi\");
                                    tampilkan.hide();
                                    loading.fadeIn(); 
                                    $.post('".site_url('/Frontoffice/tampilkan_rincian_history/'.sizeof($kolom_cari))."/".$keyisi."',{kolom_cari:\"".$this->CI->enkripsi->enkapsulasiData($kolom_cari)."\",key:\"".$tampung_key[1]."\",data:\"".$isi[$tampung_key[1]]."\" },
                                    function(data,status){
                                        loading.fadeOut();
                                        tampilkan.html(data);
                                ...
                                $(\"#tutup_rincian_history$keyisi\").click(function(){
                                    var tampilkan = $(\"#rincian_history$keyisi\");
                                    $(\"#lihat_rincian_history$keyisi\").show(500);
                                    $(\"#tutup_rincian_history$keyisi\").hide(500);
                                    tampilkan.data('');
                                    tampilkan.hide(1000);
                                });
                            });
    ...
    function penampil_tabel_no_foto_untuk_surat_masuk_frontoffice_surat_masuk_verifikasi_OLD2 ($kolom_cari,$nama_kolom_direktori_surat,$array_atribut,$query_yang_mau_ditampilkan,$submenu,$kolom_direktori='direktori',$direktori_avatar='/public/img/no-image.jpg'){
        $Recordset1=$this->CI->model_frommyframework->user_defined_query_model($query_yang_mau_ditampilkan,$token='andisinra');
        //var_dump($Recordset1);
        if (!$Recordset1) {
            echo "<center>TABEL YANG BERSESUAIAN KOSONG, SILAHKAN DIISI DULU</center>";
    ...
    function penampil_tabel_no_foto_untuk_surat_keluar ($array_atribut,$query_yang_mau_ditampilkan,$submenu,$kolom_direktori='direktori',$direktori_avatar='/public/img/no-image.jpg'){
        ...
        if (!$Recordset1) {
            ...
            if(isset($Recordset[0])){
                ...
                //$this->header_lengkap_bootstrap();
                echo "<h4>Kelola Arsip Surat Keluar Semua Bidang dan Sekretariat</h4>";
                //print_r($_SERVER);
                echo "<div ".$array_atribut[0]." ><table ".$array_atribut[1]." ><tr ".$array_atribut[2]." >";
                echo "<th scope='col' ><span >Aksi</span></th>";
                if(in_array($kolom_direktori,$tampung_key)){
